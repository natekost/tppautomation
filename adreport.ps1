...
$LogDir = "C:\tpp\"
$InactiveUsersFileName = "InactiveUsers.csv"
$InactiveFile = $LogDir + $InactiveUsersFileName
...
select-object Name,@{Name="Stamp"; Expression={[DateTime]::FromFileTime($_.lastLogonTimestamp).ToString('yyyy-MM-dd_hh:mm:ss')}} | export-csv $InactiveFile -notypeinformation 
